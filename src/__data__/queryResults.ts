export const mockQueryResults = {
  ...
  ResultItems: [
    ...
    },
    {
      ...
      DocumentURI:
        'https://www.areyouready.gov.sg/YourLifeEvents/Pages/HavingKids-Planning-for-a-child.aspx',
    },
    {
      ...
      DocumentURI:
        'https://www.cnb.gov.sg/educational-resources/for-communities/resource-toolkit/preventive-drug-education-handbook-for-parents',
    },
    {
      ...
      DocumentURI:
        'https://www.ecda.gov.sg/PressReleases/Pages/Advisory-to-Parents-Keeping-Our-Children-Safe-Against-COVID-19-Preschools-to-suspend-general-services.aspx',
    },
    {
      ...
      DocumentURI:
        'https://www.moneysense.gov.sg/articles/2018/10/planning-ahead-for-your-childs-education?sc_lang=en',
    },
    {
      ...
      DocumentURI:
        'https://www.moneysense.gov.sg/articles/2018/10/planning-your-finances-when-having-and-raising-children?sc_lang=en',
    },
    {
      ...
      DocumentURI:
        'https://www.hpb.gov.sg/article/hpb-introduces-bmi-for-age-charts-to-monitor-physical-growth-and-development-in-children-and-youth',
    },
  ],
};
